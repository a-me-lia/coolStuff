        ...
        <nav>
            <div className="flex flex-col font-mono text-[16px] w-min">
                <ul className="flex flex-row items-baseline">
                    <li className="pr-10" id='0' onClick={()=>ProcessAnimationBar("0")} >home</li>
                    <li className="pr-10" id='1' onClick={()=>ProcessAnimationBar("1")}>blog</li>
                    <li className="pr-10" id='2' onClick={()=>ProcessAnimationBar("2")}>guestbook</li>
                    <li className="pr-10" id='3' onClick={()=>ProcessAnimationBar("3")}>contact</li>
                </ul>
